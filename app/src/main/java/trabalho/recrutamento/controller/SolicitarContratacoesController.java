...
public class SolicitarContratacoesController {
        ...
        comboEntrevista.setCellFactory(param -> new ListCell<>() {
            ...
            protected void updateItem(Entrevista e, boolean empty) {
                ...
                if (empty || e == null) {
                    ...
                    Candidatura c = getCandidatura(e.getCandidaturaCpf());
                    if (c != null) {
    ...
    private void solicitar() {
        try {
            ...
            contratacao.setCandidatoCpf(entrevista.getCandidaturaCpf());
            contratacao.setVagaId(entrevista.getVagaId());
            contratacao.setRegimeContratacao(Vaga.RegimeContratacao.valueOf(regime));
            contratacao.setDataSolicitacao(LocalDate.now());
            contratacao.setStatus(Contratacao.StatusContratacao.PENDENTE);
