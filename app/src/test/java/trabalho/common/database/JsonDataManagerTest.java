 ...
 * This version now includes tests for the implemented Funcionario class.
...
public class JsonDataManagerTest {
        ...
        public void testGestorFunctionalityAndPermissions() {
                 ...
                 * trabalho.recrutamento.model.Vaga newVaga = new
                 * trabalho.recrutamento.model.Vaga();
                 * gestor.criarVaga(newVaga);
                 * assertFalse(dataManager.getData().getVagas().isEmpty(),
                 * "Vagas list should not be empty after creation.");
                 */
        ...
        public void testDataPersistenceAcrossSessions() {
                // --- Setup Phase 1: Create and save data ---
                ...
                assertFalse(reloadedData.getFuncionarios().isEmpty(),
                                "Funcionarios list should not be empty after reload.");
                assertTrue(reloadedData.getCandidatos().isEmpty(),
                                "Candidatos list should be empty as none were saved.");

                assertEquals(1, reloadedData.getAdministradores().size());
                assertEquals(1, reloadedData.getGestores().size());
                assertEquals(1, reloadedData.getFuncionarios().size());
                assertEquals("Persistent Func", reloadedData.getFuncionarios().get(0).getNome());
        }

        // ======================================================================================
        // === The following test is commented out until its dependencies are
        // implemented ===
        // ======================================================================================

        /*
         * // TODO: Uncomment this test once the Candidato class is also implemented.
         * // This test is critical for verifying that a Candidato and Funcionario can
         * coexist.
         * 
         * @Test
         ...
         * "...", 0, "root", "root", "SysAdmin", "Active", "IT", 10000);
         * admin.cadastrarUsuario(admin);
         * 
         ...
         * Funcionario funcionario = new Funcionario("Joana Silva", "333",
         * "joana.silva@corp.com", "Rua A", 12345, "joana", "pass", Role.FUNCIONARIO,
         * "Analista", "Active", "Financeiro", 5000);
